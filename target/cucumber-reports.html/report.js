...
formatter.scenario({
  "name": "Scenario-2 Delete first row in the web table",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.match({
  "location": "StepDefinitions.userClickDeleteButton()"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "user check first row in the table",
  "keyword": "Then "
});
formatter.match({
  "location": "StepDefinitions.userCheckFirstRowInTheTable()"
});
formatter.result({
  "status": "passed"
});
